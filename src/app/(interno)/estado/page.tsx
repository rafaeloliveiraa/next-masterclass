        ...
        <div className="flex flex-col gap-10">
            <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                    <input id="tarefa" type="text" value={nome} onChange={(e) => setNome(e.target.value)} className="flex-grow bg-zinc-800 px-4 py-2 rounded-md outline-none text-xl" onKeyUp={(e) => {
                        if (e.key === 'Enter') {
                            adicionarTarefa()
                        }
                    }} />
                    ...
                    {tarefas.map((tarefa, i) => {
                        return (
                            ...
                            ">
                                ...
                                <IconTrash size={18} className="text-red-500 cursor-pointer" onClick={() => excluirTarefa(i)} />
                            </li>
                        )
                    })}
                </ul>
